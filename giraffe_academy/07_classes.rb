...
class Book3
    ...
    def pages=(num)
        puts "Setting pages..."
        if num < 0
            raise ArgumentError, "Pages must be positive"
        end
        @pages = num
    end
    ...
    def read_book
        puts "Reading #{self.title} by #{self.author}, a book of #{self.pages} pages"
    end
end
...
chef2 = ItalianChef.new("Mario", 40, country_of_origin="Italy")
chef2.make_chicken()
chef2.make_pasta()
